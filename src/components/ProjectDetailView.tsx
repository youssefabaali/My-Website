              ...
              return (
                ...
                >
                  {isPlaying ? (
                    ...
                    <div
                      onClick={() => {
                        if (rawUrl && !isGifModeForUrl(vCover)) {
                      ...
                      className={`w-full h-full relative overflow-hidden flex items-center justify-center bg-neutral-900 group ${
                        rawUrl && !isGifModeForUrl(vCover) ? "cursor-pointer" : ""
                      }`}
                    >
                      {vCover ? (
                        <ImageFallback
                          ...
                          gifMode={isGifModeForUrl(vCover)}
                      ...
                      {/* Show dark overlay and Play Icon */}
                      {rawUrl && !isGifModeForUrl(vCover) && (
                        <>

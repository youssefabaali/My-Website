  ...
  return (
    ...
    >
      ...
      {(() => {
        ...
        // Parse custom bottom spacing for the description section if set
        const descBottomGap = project.descriptionBottomGap !== undefined && project.descriptionBottomGap !== null && project.descriptionBottomGap !== ""
          ? (typeof project.descriptionBottomGap === "number" ? `${project.descriptionBottomGap}px` : `${project.descriptionBottomGap}`.endsWith("px") ? `${project.descriptionBottomGap}` : `${project.descriptionBottomGap}px`)
          : undefined;

        return (
          <section
            style={descBottomGap ? { marginBottom: descBottomGap } : undefined}
            className={`px-6 md:px-10 lg:px-12 xl:px-16 max-w-[1920px] mx-auto ${descBottomGap ? "" : "cms-section-gap"}`}
          >
            {rawFields.length > 0 && (
                ...
                (() => {
                  ...
                  return (
                    <div className="w-full flex flex-col items-stretch">
                      {/* MOBILE VIEW (< sm): Clean 1-column image stack with zero offsets to preserve artwork resolution and mobile UX */}
                      <div
                        style={customRowsGap !== undefined ? { rowGap: customRowsGap, gap: customRowsGap } : undefined}

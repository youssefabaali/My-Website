...
export function ProjectDetailView({ projectId, onBack }: ProjectDetailViewProps) {
  ...
  const headingGapTablet = design.layout.headingGap ?? 24;
  const headingGapMobile = design.layout.headingGapMobile ?? design.layout.headingGap ?? 24;
  ...
  return (
    ...
    >
      ...
      {(() => {
        ...
        if (
          project.descriptionBottomGap !== undefined &&
          project.descriptionBottomGap !== null &&
          project.descriptionBottomGap !== "" &&
          project.descriptionBottomGap !== 0 &&
          project.descriptionBottomGap !== "0" &&
          project.descriptionBottomGap !== "0px"
        ) {

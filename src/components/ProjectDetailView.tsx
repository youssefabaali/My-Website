    ...
    >
      ...
      {(() => {
        ...
        return (
          <section className="px-6 md:px-12 xl:px-16 max-w-[1550px] mx-auto cms-section-gap">
            {rawFields.length > 0 && (
              <div className={`flex flex-col md:flex-row md:flex-wrap justify-start md:justify-center items-start md:items-center gap-6 md:gap-12 w-full ${hasDescription ? "border-b border-white/5 pb-12 mb-12" : ""}`}>

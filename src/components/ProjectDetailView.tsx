...
export function ProjectDetailView({ projectId, onBack }: ProjectDetailViewProps) {
  ...
  const roleToDescSpacingDesktop = project.roleToDescSpacingDesktop ?? 250;
  const roleToDescSpacingMobile = project.roleToDescSpacingMobile ?? 80;
  ...
  return (
    ...
    >
      <style>{`
        ...
        .cms-role-to-desc-spacing {
          margin-bottom: ${roleToDescSpacingMobile}px;
        }
        @media (min-width: 1024px) {
          .cms-role-to-desc-spacing {
            margin-bottom: ${roleToDescSpacingDesktop}px;
          }
        }
      `}</style>
      ...
      ══════════════════════════════════════════ */}
      <section className="px-6 md:px-12 xl:px-16 max-w-[1550px] mx-auto cms-section-gap">
        <div className="flex flex-col sm:flex-row justify-center items-start sm:items-center gap-12 border-b border-white/5 pb-12 cms-role-to-desc-spacing">
          {/* Role */}
